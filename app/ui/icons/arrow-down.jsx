export function ArrowDown({ className }) {
  return (
    <svg width="40" height="26" viewBox="0 0 40 26" className={className}>
      <rect width="40" height="26" fill="url(#pattern0_2003_3)" />
      <defs>
        <pattern
          id="pattern0_2003_3"
        ...
        >
          <use
            href="#image0_2003_3"
            transform="matrix(0.00722222 0 0 0.0111111 0.175 0)"
          />
        </pattern>
        <image
          id="image0_2003_3"
